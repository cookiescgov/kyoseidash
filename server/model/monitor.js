...
class Monitor extends BeanModel {
    ...
    toJSON(preloadData = {}, includeSensitiveData = true) {
        ...
        let data = {
            ...
            connections: this.connections ? JSON.parse(this.connections) : [],

            // Kyosei Dash — PRTG bridge
            prtg_server_id: this.prtg_server_id,
            prtg_sensor_id: this.prtg_sensor_id,
            prtg_device: this.prtg_device,
        };
