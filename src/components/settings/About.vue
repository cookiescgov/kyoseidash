<template>
    <div class="d-flex justify-content-center align-items-center">
        <div class="logo d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="fs-4 fw-bold">Kyosei Dash</div>
            ...
            <div class="my-3 update-link">
                <a href="https://github.com/cookiescgov/kyoseidash/releases" target="_blank" rel="noopener">
                    {{ $t("Check Update On GitHub") }}
                </a>
            </div>
            <div class="small text-muted mt-2">
                Built on <a href="https://github.com/louislam/uptime-kuma" target="_blank" rel="noopener">Uptime Kuma</a>
                by Louis Lam (MIT). PRTG® is a registered trademark of Paessler AG.
            </div>
