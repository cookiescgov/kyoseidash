                ...
                <div class="row">
                    <div class="small-padding d-flex gap-2 align-items-center" :class="monitorStyle">
                        ...
                        <div class="d-flex align-items-center gap-2 flex-fill" style="min-width: 0">
                            ...
                            <div v-if="monitor.connections && monitor.connections.length" class="connections-inline d-flex gap-1">
                                <a
                                    v-for="(c, i) in monitor.connections"
                                    :key="i"
                                    :href="$parent && $parent.buildConnectionUrl ? $parent.buildConnectionUrl(c) : connUrl(c)"
                                    :target="c.type === 'web' ? '_blank' : '_self'"
                                    rel="noopener noreferrer"
                                    class="conn-icon"
                                    :title="c.label || c.type.toUpperCase()"
                                    @click.stop
                                >
                                    <font-awesome-icon :icon="connIcon(c.type)" />
                                </a>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        /**
         * Kyosei Dash — build launch URI for a connection entry
        ...
        /**
         * Kyosei Dash — FontAwesome icon for a connection type
